...
load_dotenv()
with open("/workspaces/training_repository/parse_pdf/structured_biology_content_1.json", "r") as file:
...
for i in range(0, len(records), batch_size):
    ...
    dense_index.upsert_records(namespace="contents", records=batch)

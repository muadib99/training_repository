...
def get_definitions_with_gemini(api_key, text_chunk):
    ...
    try:
        ...
        Your task is to look through the provided text and find all terms listed under a "KEY WORDS" or "KEY TERMS" section.
        ...
        You will format the output as a valid JSON list of objects. Each object must contain three key-value pairs:
        1. "id": goes sequentially from one on eg, 1,2,3,4,5,6,7,8.
...
def main():
    ...
    YOUR_API_KEY = "AIzaSyCDs_KNM-OvtBciZL3QnNKxqVlo-SjDcOg" # Replace with your actual Gemini API key
    INPUT_PDF_PATH = "/workspaces/training_repository/parse_pdf/Grade-11-Biology-Textbook.pdf"
    OUTPUT_JSON_PATH = "keyword_definitions_3.json" # Saving as .json is more appropriate
    
    PAGES_TO_PROCESS = 204
    CHUNK_SIZE = 60
    # -----------------------------------------
